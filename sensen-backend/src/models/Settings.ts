...
// Interface for Social Link sub-document
export interface ISocialLink {
  name: string;
  url: string;
  icon: string; // e.g., 'FaFacebook', 'FaTwitter', or a URL to an icon image
}

// Define the interface for a Settings document
export interface ISettings extends Document {
  ...
  fontFamily: string;
  generalTextColor: string; // New
  pageBackgroundColor: string; // New
  generalBackgroundColor: string; // New
  headerBackgroundColor: string; // New
  footerBackgroundColor: string; // New
  homepageTitle: string;
  catalogPageTitle: string;
  homepageFeaturedSectionTitle: string;
  // homepageFeaturedSectionImageUrl: string; // Removed
  homepageAboutUsTitle: string;
  homepageAboutUsText: string;
  aboutUsImageUrl: string; // New
  mailingListImageUrl: string; // New field for mailing list section image
  homepageMailingListTitle: string;
  socialLinks: ISocialLink[]; // New field for social links
  createdAt: Date;
  updatedAt: Date;
}
